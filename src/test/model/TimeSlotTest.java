...
public class TimeSlotTest {
    ...
    void testGetNumberOfBookedMembers() {
        assertEquals(0, testTimeSlot1.getBookedMembers());
        testTimeSlot1.bookSlot(member1);
        assertEquals(1, testTimeSlot1.getBookedMembers());
        testTimeSlot1.bookSlot(member2);
        assertEquals(2, testTimeSlot1.getBookedMembers());
        testTimeSlot1.bookSlot(member3);
        assertEquals(3, testTimeSlot1.getBookedMembers());
    }
